    ...
    <div class="container d-flex align-items-center justify-content-between position-relative">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="${pageContext.request.contextPath}/mentor/<%=mentor.getMentor_id()%>/edit_profile">แก้ไขข้อมูลส่วนตัว</a></li>
                <li><a class="nav-link scrollto" href="${pageContext.request.contextPath}/mentor/list_student_by_mentor/<%=mentor.getMentor_id()%>">ประเมินผลการฝึกสหกิจศึกษา</a></li>
                <li><a class="nav-link scrollto" href="${pageContext.request.contextPath}/mentor//list_evaluate_by_mentor/<%=mentor.getMentor_id()%>">ผลการประเมินการฝึกสหกิจศึกษา</a></li>
                <li><%=mentor.getMentor_name()%> <%=mentor.getMentor_lastname()%></li>
